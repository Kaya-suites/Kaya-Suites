              ...
              >
                ...
                {!isEditing && onRename && (
                  <button
                    ...
                    className={`opacity-0 group-hover:opacity-100 pr-2 transition-opacity shrink-0 ${isActive ? "text-white" : "text-[var(--color-muted)]"}`}
                    title="Rename"
                  >
          ...
          return (
            ...
            >
              {isEditing ? (
                ...
                >
                  <div className="truncate leading-5 text-xs font-bold font-mono">{s.title}</div>
              ...
              {!isEditing && onRename && (
                <button
                  onClick={(e) => startEdit(s, e)}
                  className={`opacity-0 group-hover:opacity-100 pt-2.5 pr-2 transition-opacity shrink-0 ${isActive ? "text-white" : "text-[var(--color-muted)]"}`}
                  title="Rename"
                >
                  <svg width="11" height="11" viewBox="0 0 16 16" fill="none">
                    <path d="M11 2l3 3-9 9H2v-3l9-9z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
